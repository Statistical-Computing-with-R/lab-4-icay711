...
The childcare_costs dataset contains 61 columns (variables) with 34567 rows (observations). This dataset was collected by the National Database of Childhood Prices (NDCP) from 2008 to 2018. 
